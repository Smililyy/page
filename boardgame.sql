...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 10, 2023 lúc 04:08 PM
...
--
-- Cấu trúc bảng cho bảng `boardgame`
--
...
--
-- Đang đổ dữ liệu cho bảng `boardgame`
--
...
('BG006', 'The Werewolves of Millers Hollow: The Pact', 50, 'Party Games ', 7, 'The Werewolves of Millers Hollow: The Pact bao gồm trò chơi cơ bản The Werewolves of Millers Hollow cũng như ba bản mở rộng hiện có cho trò chơi đó kể từ năm 2014: New Moon, Characters và The Village.'),
...
('BG015', 'My Fathers Work', 125, 'Wargame & Strategy ', 7, 'Trong My Fathers Work, 2-4 người chơi đóng vai các nhà khoa học điên cạnh tranh nhau được giao một trang trong nhật ký của cha họ, cùng với một khu đất rộng lớn để thực hiện các thí nghiệm quỷ quyệt của họ. Người chơi kiếm điểm bằng cách hoàn thành Thử nghiệm, hỗ trợ Thị trấn trong nỗ lực của mình và hy vọng hoàn thành Công việc của Cha họ trong trò chơi tường thuật phân nhánh dựa trên ứng dụng này.'),
...
('BG032', 'Chess: Luxury Version', 65, 'Chess ', 17, 'Bộ Cờ Tướng Cao Cấp là bộ cờ vua hoàn toàn bằng gỗ cao cấp. Nó có một bảng gỗ hoàn thiện đẹp mắt và các quân cờ bằng gỗ có đáy nhung để bảo vệ bảng và mang lại trải nghiệm chơi thú vị.'),
...
('BG040', 'Pinata Blast', 15, 'Dice Games ', 18, 'Mỗi vòng trong Piñata Blast, một người nào đó thả xúc xắc, sau đó mọi người cố gắng lấy viên xúc xắc phù hợp với quân bài của mình trước, đồng thời không lấy kẹo thối. Kiếm được nhiều điểm nhất để giành chiến thắng!'),
...
(50, 'my', 'BG001', 1, 'Outer Rim', 74.999);
...
--
-- Cấu trúc bảng cho bảng `order_game`
--
...
('my', '2003-02-02', 100, 1),
('my', '2003-02-02', 10, 2),
('Tu', '2023-07-01', 35, 1350),
('21522106', '2023-06-29', 65, 1429),
('Test1', '2023-07-01', 65, 1793),
('Trà My', '2023-07-10', 99.998, 2506),
('21522106', '2023-06-28', 65, 2567),
('21522109', '2023-07-10', 135, 3268),
('Trà My', '2023-07-10', 75, 3513),
('Trà My', '2023-07-10', 81.988, 4329),
('smilily', '2023-06-09', 270, 4367),
('smilily', '2023-06-22', 130, 4396),
('hoangngochong', '2023-06-22', 120, 4397),
('smilily', '2023-06-23', 62, 4401),
('amika', '2023-06-24', 112, 4402),
('amika', '2023-06-24', 40, 4403),
('HOÀNG NGỌC HỒNG', '2023-06-26', 65, 4824),
('gggghjk', '2023-07-10', 1925, 5034),
('21522106', '2023-06-29', 65, 6039),
('21522109', '2023-07-10', 175, 6172),
('21522106', '2023-06-28', 65, 6271),
('HOÀNG NGỌC HỒNG', '2023-06-28', 65, 6466),
('HOÀNG NGỌC HỒNG', '2023-06-27', 65, 6492),
('Red', '2023-06-27', 65, 7276),
('Trà My', '2023-07-10', 75, 7613),
('Trà My', '2023-07-10', 175, 8436),
('HOÀNG NGỌC HỒNG', '2023-07-01', 65, 8480),
('HOÀNG NGỌC HỒNG', '2023-06-28', 65, 9431);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `thuegame`
--
...
--
-- Đang đổ dữ liệu cho bảng `thuegame`
--
...
--
-- Cấu trúc bảng cho bảng `tich_diem`
--
...
--
-- Đang đổ dữ liệu cho bảng `tich_diem`
--
...
--
-- Cấu trúc bảng cho bảng `tragame`
--
...
--
-- Đang đổ dữ liệu cho bảng `tragame`
--
...
--
-- AUTO_INCREMENT cho bảng `tich_diem`
--
ALTER TABLE `tich_diem`
  MODIFY `Id_diem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
